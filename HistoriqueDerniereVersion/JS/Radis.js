...
Gerer.onclick = function(){
    ...
    document.querySelector(".Arracher").style.visibility = "hidden";
...
Arracher.onclick = function(){
    ...
    // document.location.href="CarotteAr.html";

    document.querySelector(".T32").style.visibility = "hidden";
    document.querySelector(".Arracher").style.visibility = "visible";
...
TP21.onclick = function(){
    // alert("Les radis on été transplanté sur la parcelle 2-1");
    document.querySelector(".T32").style.visibility = "hidden";
    document.location.href="RadisTr.html";
