...
var ChouDeBruxelle = document.getElementById('ChouDeBruxelle');
...
Carotte.onclick = function(){
    ...
    document.location.href="Semer.html";

}
Radis.onclick = function(){
    document.querySelector(".Radis").style.visibility = "visible";
    document.querySelector(".ChouDeBruxelle").style.visibility = "hidden";
    document.querySelector(".DoubleB").style.visibility = "hidden";
    document.querySelector(".Sarclage").style.visibility = "hidden";
    document.querySelector(".Desherbage").style.visibility = "hidden";
    document.querySelector(".Amendement").style.visibility = "hidden";
    document.querySelector(".Traitement").style.visibility = "hidden";

}
ChouDeBruxelle.onclick = function(){
    document.querySelector(".Radis").style.visibility = "hidden";
    document.querySelector(".ChouDeBruxelle").style.visibility = "visible";
    document.querySelector(".DoubleB").style.visibility = "hidden";
    document.querySelector(".Sarclage").style.visibility = "hidden";
    document.querySelector(".Desherbage").style.visibility = "hidden";
    document.querySelector(".Amendement").style.visibility = "hidden";
...
DoubleBechage.onclick = function(){
    ...
    document.querySelector(".Radis").style.visibility = "hidden";
    document.querySelector(".ChouDeBruxelle").style.visibility = "hidden";
    document.querySelector(".DoubleB").style.visibility = "visible";
    document.querySelector(".Sarclage").style.visibility = "hidden";
    document.querySelector(".Desherbage").style.visibility = "hidden";
    document.querySelector(".Amendement").style.visibility = "hidden";
    document.querySelector(".Traitement").style.visibility = "hidden";
...
Sarclage.onclick = function(){
    ...
    document.querySelector(".ChouDeBruxelle").style.visibility = "hidden";
    document.querySelector(".DoubleB").style.visibility = "hidden";
    document.querySelector(".Sarclage").style.visibility = "visible";
    document.querySelector(".Desherbage").style.visibility = "hidden";
    document.querySelector(".Amendement").style.visibility = "hidden";
    document.querySelector(".Traitement").style.visibility = "hidden";
}
Desherbage.onclick = function(){
    ...
    document.querySelector(".DoubleB").style.visibility = "hidden";
    document.querySelector(".Sarclage").style.visibility = "hidden";
    document.querySelector(".Desherbage").style.visibility = "visible";
    document.querySelector(".Amendement").style.visibility = "hidden";
    document.querySelector(".Traitement").style.visibility = "hidden";
...
Amendement.onclick = function(){
    ...
    document.querySelector(".Sarclage").style.visibility = "hidden";
    document.querySelector(".Desherbage").style.visibility = "hidden";
    document.querySelector(".Amendement").style.visibility = "visible";
    document.querySelector(".Traitement").style.visibility = "hidden";
}
TraitementPurin.onclick = function(){
    ...
    document.querySelector(".Desherbage").style.visibility = "hidden";
    document.querySelector(".Amendement").style.visibility = "hidden";
    document.querySelector(".Traitement").style.visibility = "visible";
}