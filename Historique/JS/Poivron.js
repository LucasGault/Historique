...
Recolter.onclick = function(){
    ...
    alert("Les poivrons ont été récolter")
}

Arracher.onclick = function(){
    alert("Les poivrons ont été arracher !");
}
...
TP21.onclick = function(){
    alert("Les poivrons on été transplanté sur la parcelle 2-1");
}
TP32.onclick = function(){
    alert("Les poivrons on été transplanté sur la parcelle 3-2");
}
